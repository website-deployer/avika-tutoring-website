/* ===== Momentum Tutoring — Premium Script ===== */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            if (target) {
                ...
                window.scrollTo({ top: offsetPos, behavior: prefersReducedMotion ? 'auto' : 'smooth' });
            }
        });
    });
    ...
    /* =============================================
       MODAL LOGIC (with focus trap + restore)
    ============================================= */
    ...
    if (volForm) {
        volForm.addEventListener('submit', (e) => {
            ...
            showToast('success', 'Application ready', 'Your email app opened with a draft. Click Send to finish.');
        });
    }
    ...
    if (reqForm) {
        reqForm.addEventListener('submit', (e) => {
            ...
            resetForm(reqForm);
            window.open(mailtoLink, '_blank');
            showToast('success', 'Request ready', 'Your email app opened with a draft. Click Send to submit.');
        });
    }
